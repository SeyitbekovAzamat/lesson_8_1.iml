...
public class RPG_Game {
    ...
    public static void start() {
        ...
        Witcher witcher = new Witcher(500,0);
        Hacker hacker = new Hacker(240, 25);
        Hero[] heroes = {warrior, doc, magic, berserk, junior, thor,witcher, hacker};
